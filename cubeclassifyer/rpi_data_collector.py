    ...
    try:
        while True:
            ...
            if key == ord("q") or key == ord("Q"):
                ...
                success, error = process_and_save(frame, roi, save_path)
                if success:
                    ...
                    status_color = (0, 0, 200)  # Bright red
                    status_timeout = 60  # Show error longer
                    print(f"ERROR saving {save_path}: {error}")
